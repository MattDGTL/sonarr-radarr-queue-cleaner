...
2#. `docker run -d --name --SONARR_API_KEY='123456' --RADARR_API_KEY='123456' --SONARR_URL='http://sonarr:8989' --RADARR_URL='http://radarr:7878' --API_TIMEOUT='3600' media-cleaner media-cleaner`
